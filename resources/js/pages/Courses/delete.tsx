...
interface Props {
    ...
    dataToDelete: CourseProps | null;
}
export default function DeleteCourse({ open, setOpen, dataToDelete }: Props) {
    const deleteData = () => {
        router.delete(route('course.destroy', dataToDelete?.id), {
            preserveScroll: true,
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong className="text-orange-400 uppercase">{dataToDelete?.course_name}</strong> from our servers.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
