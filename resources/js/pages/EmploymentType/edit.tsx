...
import { EmploymentTypeProps, EmploymentTypes } from '@/types/employmentType';
...
interface Props {
    ...
    dataToEdit: EmploymentTypeProps;
}
export function EditEmploymentType({ open, setOpen, dataToEdit }: Props) {
    const { data, setData, put, processing, reset, errors } = useForm<EmploymentTypes>({
        employment_type: dataToEdit.employment_type || '',
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        put(route('employment.update', dataToEdit.id), {
            ...
            <AlertDialogContent>
                <form onSubmit={submit}>
                    <AlertDialogHeader className="mb-3">
                        <AlertDialogTitle>Edit Employment Type</AlertDialogTitle>
                        <AlertDialogDescription>
