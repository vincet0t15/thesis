...
interface Props {
    ...
    dataToDelete: EmploymentTypeProps;
}
export default function DeleteEmploymentType({ open, setOpen, dataToDelete }: Props) {
    const deleteData = () => {
        router.delete(route('employment.destroy', dataToDelete.id), {
            preserveScroll: true,
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong className="text-orange-400 uppercase">{dataToDelete.employment_type}</strong> from our servers.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
