...
interface Props {
    ...
    dataToDelete: YearLevelProps | null;
}
export default function DeleteYearLevel({ open, setOpen, dataToDelete }: Props) {
    const deleteData = () => {
        router.delete(route('year-level.destroy', dataToDelete?.id), {
            preserveScroll: true,
