...
export default function EditEvents({ open, setOpen, event }: Props) {
    const { data, setData, processing, errors, put, reset } = useForm<EventTypes>({
        name: event.name,
            ...
            <DialogContent>
                <form className="mt-4 flex flex-col gap-6" onSubmit={submit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>Fill in the details below to edit the event.</DialogDescription>
                    </DialogHeader>
