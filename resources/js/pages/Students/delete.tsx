...
interface Props {
    ...
    dataToDelete: StudentProps | null;
}
export default function DeleteStudent({ open, setOpen, dataToDelete }: Props) {
    const deleteData = () => {
        router.delete(route('student.destroy', dataToDelete?.id), {
            preserveScroll: true,
